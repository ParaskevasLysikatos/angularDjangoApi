...
employees!:any;
  ...
  constructor(private formBuilder: FormBuilder,private devSrv:DevicesSrvService,private toastr: ToastrService, private router: Router,private empSrv:EmployeesSrvService) {
  ...
  onSubmit(){
   //console.log( this.employeeForm.value);
    this.devSrv.createDevice(this.deviceForm.value).subscribe((res: any) => { this.router.navigate([{ outlets: { primary: 'devices', menu: 'devices' } }]);},
